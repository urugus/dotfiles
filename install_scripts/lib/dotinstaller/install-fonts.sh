...
curl -fL -o /tmp/HackNerdFont.zip \
  "https://github.com/ryanoasis/nerd-fonts/releases/download/${HACK_NERD_FONT_VERSION}/Hack.zip"
verify_checksum /tmp/HackNerdFont.zip "$HACK_NERD_FONT_SHA256"
...
verify_checksum /tmp/FiraCode.zip "$FIRA_CODE_SHA256"
