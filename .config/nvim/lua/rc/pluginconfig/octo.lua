require("octo").setup({
  ...
  default_merge_method = "merge", -- default merge method which should be used for both `Octo pr merge` and merging from picker, valid values: `merge`, `rebase` or `squash`
